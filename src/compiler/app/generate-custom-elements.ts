...
export async function generateCustomElementHosts(config: d.Config, compilerCtx: d.CompilerCtx, cmpRegistry: d.ComponentRegistry, outputTarget: d.OutputTarget) {
...
var ${cmpMeta.componentClass}Component = /** @class **/ (function() {
  ...
  ${cmpMeta.componentClass}.getModule = function(opts) {${Object.keys(cmpMeta.bundleIds).map(styleMode => {
      let fileName = (typeof cmpMeta.bundleIds !== 'string') ? cmpMeta.bundleIds[styleMode] : cmpMeta.bundleIds;
      fileName = './es5/' + fileName;
